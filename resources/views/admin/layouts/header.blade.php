...
<head>
    ...
    <!-- Theme Styles -->
    <link href="{{ asset('public/admin/assets/css/dark-theme.css') }}" rel="stylesheet" />
    ...
    <div class="wrapper">
        ...
        <header class="top-header">
            <nav class="navbar navbar-expand">
                ...
                <div class="searchbar d-none d-xl-flex ms-auto" style="margin-top: 20px; position: relative;">
                </div>
