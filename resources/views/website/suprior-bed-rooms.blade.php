...
<div class="breadcumb-area" style="background: linear-gradient(0deg, rgb(0 0 0 / 54%), rgb(0 0 0)), url({{ asset('public/assets/images/room/about-b.jpg') }}); background-position: center; background-repeat: no-repeat; background-size: cover; ">
	<div class="container">
					<div class=" align-items-center">
						<h4 style="color: rgb(255, 255, 255);"> 2BHK Luxury Villa  - Ground Floor  </h4>
					</div>
	</div>
</div>
<!--==================================================-->
					...
					<div class="room-details-list owl-carousel">
					    <div class="col-lg-12">
					    	<div class="room-detils-thumb">
					    		<img src="{{ asset('public/assets/images/room-details/1a.jpg') }}" alt="">
					    	</div>
					    </div>							   
					    <div class="col-lg-12">
					    	<div class="room-detils-thumb">
					    		<img src="{{ asset('public/assets/images/room-details/2a.jpg') }}" alt="">
					    	</div>
					    </div>		
						<div class="col-lg-12">
					    	<div class="room-detils-thumb">
					    		<img src="{{ asset('public/assets/images/room-details/3a.jpg') }}" alt="">
					    	</div>
					    </div>	
						<div class="col-lg-12">
					    	<div class="room-detils-thumb">
					    		<img src="{{ asset('public/assets/images/room-details/4a.jpg') }}" alt="">
					    	</div>
					    </div>								    
					</div>
				</div>
                           ...
                           <p class="room-detils-desc" data-cue="zoomIn">Conveniently fashion pandemic potentialities for team driven 
                            ...
                            <div class="room-details-check-box" data-cue="zoomIn">
                            	<div class="room-details-check-content">
                            		<span><img src="{{ asset('public/assets/images/inner/room-details-1.png') }}" alt="">Check In</span>
                            ...
                            <div class="room-details-check-box upper" data-cue="zoomIn">
                            	<div class="room-details-check-content">
                            		<span><img src="{{ asset('public/assets/images/inner/room-details-2.png') }}" alt="">Check Out</span>
					...
					<div class="col-lg-12">
						...
						<div class="room-details-amenities">
							...
							<div class="room-amenities-item">
								<ul>
									<li><img src="{{ asset('public/assets/images/inner/room-amenities-1.png') }}" alt="">2 - 5 Persons</li>
									<li><img src="{{ asset('public/assets/images/inner/room-amenities-2.png') }}" alt="">Free WiFi Available</li>
									<li><img src="{{ asset('public/assets/images/inner/room-amenities-3.png') }}" alt="">Swimingpools</li>
									<li><img src="{{ asset('public/assets/images/inner/room-amenities-4.png') }}" alt="">Breakfast</li>
									<li><img src="{{ asset('public/assets/images/inner/room-amenities-5.png') }}" alt="">250 SQFT Rooms</li>
									<li><img src="{{ asset('public/assets/images/inner/room-amenities-6.png') }}" alt="">Gym facilities</li>
								</ul>
							</div>
						</div>
					</div>
					    ...
					    <div class="col-lg-12">
						    <div class="single-brand-box">
							    <div class="brand-thumb">
							    	<img src="{{ asset('public/assets/images/home-1/brand-1.png') }}" alt="">
							    </div>
						    </div>
					    </div>					   
					    <div class="col-lg-12">
						    <div class="single-brand-box">
							    <div class="brand-thumb">
							    	<img src="{{ asset('public/assets/images/home-1/brand-2.png') }}" alt="">
							    </div>
						    </div>
					    </div>					    
					    <div class="col-lg-12">
						    <div class="single-brand-box">
							    <div class="brand-thumb">
							    	<img src="{{ asset('public/assets/images/home-1/brand-3.png') }}" alt="">
							    </div>
						    </div>
					    </div>
					</div>
